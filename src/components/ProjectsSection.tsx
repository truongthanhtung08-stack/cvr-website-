          ...
          {visible.map((p) => (
            ...
            >
              ...
              <div className="relative aspect-[4/3] overflow-hidden">
                ...
                />
                <span className="absolute left-3 top-3 bg-white/90 px-2.5 py-1 text-xs font-bold uppercase tracking-wide text-cvr-ink">
                  {p.status}
                </span>
              </div>
              <div className="flex flex-1 flex-col p-4">
                <h3 className="font-bold leading-snug text-cvr-ink">{p.name}</h3>
                ...
                <div className="mt-3 flex items-center justify-between border-t border-cvr-line pt-3">
                  ...
                  <span className="text-sm font-bold text-cvr-ink">{p.priceFrom}</span>
                </div>
              </div>
            </Link>
          ))}
