...
export default function SavedClient() {
  ...
  if (items.length === 0) {
    return (
      <div className="mt-8 flex flex-col items-center justify-center rounded-2xl border border-dashed border-cvr-line py-20 text-center">
        ...
        <p className="text-cvr-body">Bạn chưa lưu tin nào.</p>
        <p className="mt-1 text-sm text-cvr-muted">Bấm biểu tượng trái tim ❤ trên mỗi tin để lưu lại xem sau.</p>
