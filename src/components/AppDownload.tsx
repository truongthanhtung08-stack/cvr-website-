  ...
  return (
    <section className="section-edge bg-white">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-16">
        {/* Panel nền tối nổi bật (chuyên nghiệp, thu hút) */}
        <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-cvr-ink to-[#2b2b2e] p-8 shadow-lux sm:p-12">
          <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
            {/* Trái: giới thiệu + đánh giá + tải */}
            <div>
              <span className="text-xs font-semibold uppercase tracking-[0.25em] text-cvr-gold-soft">
              ...
              <div className="mt-7 flex flex-wrap items-center gap-3">
                <a href="#" className="flex items-center gap-3 rounded-xl bg-white px-5 py-3 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-0.5 hover:bg-white/90">
                ...
                {/* QR */}
                <div className="flex flex-col items-center gap-1 rounded-xl bg-white p-2">
                  <Image
...
function PhoneMockup() {
  return (
    <div className="relative w-[220px] rounded-[2.2rem] border-[6px] border-black/80 bg-white shadow-2xl shadow-black/40">
      {/* Notch */}
