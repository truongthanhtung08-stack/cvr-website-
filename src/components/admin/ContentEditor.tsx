  ...
  return (
    <div className="space-y-2">
      ...
      <textarea
        ...
        className="min-h-[95px] w-full resize-y rounded-lg border border-cvr-line bg-white px-3 py-2.5 text-sm leading-relaxed text-cvr-ink placeholder-cvr-faint outline-none transition focus:border-cvr-ink sm:min-h-[86px]"
      />
