...
export default function ShareButtons({ title }: { title: string }) {
  ...
  return (
    <div ref={boxRef} className="relative w-full sm:w-auto">
      ...
      {open && (
        <div className="absolute left-0 top-[calc(100%+8px)] z-30 w-60 overflow-hidden rounded-2xl border border-cvr-line bg-white py-1.5 shadow-[0_12px_36px_rgba(0,0,0,0.16)]">
          <a
