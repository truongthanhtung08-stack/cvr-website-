...
const DIEM = [
  ["Đà Nẵng — Sơn Trà", 16.0678, 108.2447, "Đà Nẵng"],
  ["Đà Nẵng — Hòa Xuân", 16.02, 108.2269, "Đà Nẵng"],
  ["Hội An (nay Đà Nẵng)", 15.8801, 108.338, "Đà Nẵng"],
  ["Huế — Phú Xuân", 16.4637, 107.5909, "Huế"],
  ["Huế — Thuận An", 16.568, 107.63, "Huế"],
  ["Quy Nhơn (nay Gia Lai)", 13.7829, 109.2196, "Gia Lai"],
  ["Nha Trang (Khánh Hòa)", 12.2388, 109.1967, "Khánh Hòa"],
  ["Cam Ranh (Khánh Hòa)", 11.9214, 109.1591, "Khánh Hòa"],
  ["Phan Thiết (nay Lâm Đồng)", 10.928, 108.1, "Lâm Đồng"],
  ["Mũi Né (nay Lâm Đồng)", 10.933, 108.287, "Lâm Đồng"],
  ["Đông Hà (Quảng Trị)", 16.8163, 107.1003, "Quảng Trị"],
  ["Đồng Hới (nay Quảng Trị)", 17.4689, 106.6223, "Quảng Trị"],
  ["TP. Quảng Ngãi", 15.1214, 108.8044, "Quảng Ngãi"],
  ["Dung Quất (Quảng Ngãi)", 15.38, 108.77, "Quảng Ngãi"],
];

const he = process.argv[2] === "cu" ? "cu" : "moi";
let dungTinh = 0, saiTinh = 0, thieuPhuong = 0;
console.log(`HỆ ĐỊA CHỈ: ${he.toUpperCase()}\n`);
for (const [ten, lat, lng, tinhMongDoi] of DIEM) {
  ...
  const ok = kq.province === tinhMongDoi;
  ok ? dungTinh++ : saiTinh++;
...
console.log(`\nĐúng tỉnh ${dungTinh}/${DIEM.length} · sai ${saiTinh} · không ra phường ${thieuPhuong}`);
