# AGENTS.md — Dự án COASTAL LAND (CVR)

> File này Codex tự đọc mỗi khi mở dự án. Luôn cập nhật khi có thay đổi quan trọng.
...
| # | Thành phần | Vai trò |
|---|---|---|
| 1 | **AI Search** | Hiểu truy vấn tự nhiên tiếng Việt ("căn hộ 2PN gần biển dưới 3 tỷ") → tự tách khu vực/loại hình/giá/tiện ích. Dùng Codex API khi cần. |
...
```
cvr-website/
├── AGENTS.md          ← file này (bối cảnh + nguyên tắc làm việc)
...
3. **Không thuê developer** — dùng Codex cho toàn bộ lập trình.
...
7. Vai trò của Codex: vừa là CTO + CFO + CMO của dự án.
...
✅ Đã xong:
  - Môi trường: Node 20, Git, WSL, Codex CLI
